...
/** Console methods required by the browser logger adapter. */
...
/** Options for creating a browser-safe logger facade. */
...
/** Creates a browser logger that writes structured payloads through console methods. */
