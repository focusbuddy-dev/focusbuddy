...
- The web module structure and implementation context policy note is available at [docs/platform/web-module-structure-and-context-policy.md](docs/platform/web-module-structure-and-context-policy.md).
- The API module structure and implementation context policy note is available at [docs/platform/api-module-structure-and-context-policy.md](docs/platform/api-module-structure-and-context-policy.md).
