...
export function isWebBaselineCaptureEnabled() {
  const configuredValue = process.env.NEXT_PUBLIC_FOCUSBUDDY_WEB_BASELINE_CAPTURE_ENABLED;
  const configuredContext = process.env.NEXT_PUBLIC_FOCUSBUDDY_WEB_BASELINE_CAPTURE_CONTEXT;
