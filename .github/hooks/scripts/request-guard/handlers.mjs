...
import { buildPromptLikeText, getStatePath, safeWriteJson, safeReadJson } from './shared.mjs';
...
export function handlePreToolUse(event) {
  ...
  process.stdout.write(JSON.stringify(buildPreToolPermissionOutput(cwd, event, state)));
}
